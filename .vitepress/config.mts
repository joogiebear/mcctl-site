...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      '/guide/': [{ text: 'Start here', items: guide.slice(0,3) }, { text: 'Understand & troubleshoot', items: guide.slice(3) }, { text: 'Reference', items: reference }],
      '/reference/': [{ text: 'Start here', items: guide.slice(0,3) }, { text: 'Understand & troubleshoot', items: guide.slice(3) }, { text: 'Reference', items: reference }],
    },
