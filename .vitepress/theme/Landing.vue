...
const questions = [
  { q:'What exactly is SpawnLoft?', a:'A desktop app for running Minecraft Java Edition servers on your own Windows PC. It brings server controls, plugins, worlds, backups, and more into one place.' },
...
<template>
  <div class="showcase-site">
    ...
    <header class="site-header">
      ...
      <nav class="desktop-nav" aria-label="Main navigation"><a href="#product">The app</a><a href="#inside">The possibilities</a><a href="/guide/getting-started">Docs <BrandIcon name="arrow" :size="12" /></a></nav>
      ...
      <nav v-if="menu" id="mobile-navigation" class="mobile-nav" aria-label="Mobile navigation" @click="menu=false"><a href="#product">Explore the app</a><a href="#inside">The possibilities</a><a href="/guide/getting-started">Documentation</a><a href="#download">Get SpawnLoft</a></nav>
    </header>
    <main id="main">
    ...
    <footer class="site-footer"><div class="footer-top"><a href="/" class="site-logo"><BrandIcon name="mark" :size="33" /><span>spawnloft.</span></a><p>A little control.<br> A whole world of possibilities.</p><nav aria-label="Footer navigation"><a href="/guide/getting-started">Documentation</a><a href="/changelog">Changelog</a><a href="https://github.com/joogiebear/spawnloft">GitHub ↗</a><a href="https://github.com/joogiebear/spawnloft/discussions">Community ↗</a></nav></div><div class="footer-bottom"><span>BUILT BY JOOGIEBEAR & CONTRIBUTORS · MIT LICENSED</span><span>NOT AN OFFICIAL MINECRAFT PRODUCT.</span><a href="#main">BACK TO TOP ↑</a></div></footer>
  </div>
</template>
<style scoped>
